<div class="footer bg-primary text-white" style="background-color: #2652a9 !important">
    <!-- <div class="container"> -->
        <div class="row">
            <div class="col-md-3">
            ...
            <div class=" text-center">
                <div class="link-footer itens-center">
                    <p>Eduarda Moreira</p>
                    <p>Lara Marcelino</p>
                    <p>Luisa Prado</p>
                    <p>Mariana Godoi</p>
                    <p>Nicole Salcedo</p>
                    <p>Victor Hugo</p>
                    <p>&copy; 2024 Verifica Ai. Todos os direitos reservados. | <a href="#contact" class="text-white text-decoration-none">Contato</a></p>
                </div>
            </div>
        </div>
